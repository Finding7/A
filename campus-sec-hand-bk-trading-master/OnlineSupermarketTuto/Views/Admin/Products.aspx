...
<asp:Content ID="Content2" ContentPlaceHolderID="MyContent" runat="server">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="mb-3">
                    <label for="" class="form-label text-success">作者</label>
                       <input type="text" placeholder="" autocomplete="off" runat="server" id="AuthorTb" class="form-control" />
                </div>
                <div class="mb-3">
                    <label for="" class="form-label text-success">上架用户</label>
                    <asp:DropDownList ID="SellerCb" runat="server" class="form-control"></asp:DropDownList>
                </div>
                <div class="row">
            ...
            <div class="col-md-8">
                <asp:GridView ID="ProductList" runat="server" AllowPaging="True" PageSize="10" OnPageIndexChanging="ProductList_PageIndexChanging" class="table" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateSelectButton="True" OnSelectedIndexChanged="ProductList_SelectedIndexChanged">
