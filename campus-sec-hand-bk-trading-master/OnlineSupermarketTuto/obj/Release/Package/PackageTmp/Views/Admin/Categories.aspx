...
<asp:Content ID="Content2" ContentPlaceHolderID="MyContent" runat="server">
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                <h3 class="text-center">书本类目管理</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
                <div class="mb-3">
                    <label for="" class="form-label text-success">书本类目名称</label>
            ...
            <div class="col-md-8">
                <asp:GridView ID="CategoryList" runat="server" AllowPaging="True" PageSize="10" OnPageIndexChanging="CategryList_PageIndexChanging" class="table" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateSelectButton="True" OnSelectedIndexChanged="CategoryList_SelectedIndexChanged">
