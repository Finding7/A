    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="mb-3">
                    <label for="" class="form-label text-success">出版社地址</label>
            ...
            <div class="col-md-8">
                <asp:GridView ID="ManufactList" runat="server" AllowPaging="True" PageSize="10" OnPageIndexChanging="ManufctList_PageIndexChanging" class="table" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateSelectButton="True" OnSelectedIndexChanged="ManufactList_SelectedIndexChanged">
